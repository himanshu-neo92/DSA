...
// Implement a class that manually manages a raw int pointer and correctly
// handles copy construction, copy assignment, move construction,
// and move assignment.
//
// ==================== CONCEPTS ====================
...
public:
    ...
    ManagedInt(const ManagedInt& obj) : ptr(nullptr) {}

    // TODO: implement copy assignment (deep copy, self-assignment safe)
    ManagedInt& operator=(const ManagedInt& obj) { return *this; }

    // TODO: implement move constructor (steal resources, null source)
    ManagedInt(ManagedInt&& obj) noexcept : ptr(nullptr) {}

    // TODO: implement move assignment (release current, steal, null source)
    ManagedInt& operator=(ManagedInt&& obj) noexcept { return *this; }
